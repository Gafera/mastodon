...
gem 'aws-sdk-s3', '~> 1.66', '>= 1.66.0', require: false
gem 'fog-core', '<= 2.1.0'
...
gem 'stoplight', '~> 2.2.0'
gem 'strong_migrations', '~> 0.6', '>= 0.6.8'
...
gem 'json-ld'
gem 'json-ld-preloaded', '~> 3.1', '>= 3.1.2'
gem 'rdf-normalize', '~> 0.4'

group :development, :test do
  gem 'fabrication', '~> 2.21'
  gem 'fuubar', '~> 2.5'
  gem 'i18n-tasks', '~> 0.9', '>= 0.9.31', require: false
  gem 'pry-byebug', '~> 3.9'
  gem 'pry-rails', '~> 0.3'
...
group :development do
  ...
  gem 'memory_profiler'
  gem 'rubocop', '~> 0.84', '>= 0.84.0', require: false
