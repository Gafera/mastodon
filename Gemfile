...
gem 'aws-sdk-s3', '~> 1.67', '>= 1.67.0', require: false
gem 'fog-core', '<= 2.1.0'
...
gem 'sanitize', '~> 5.2', '>= 5.2.0'
gem 'sidekiq', '~> 6.1', '>= 6.1.0'
gem 'sidekiq-scheduler', '~> 3.1', '>= 3.1.0'
...
gem 'stoplight', '~> 2.2.0'
gem 'strong_migrations', '~> 0.7', '>= 0.7.0'
gem 'tty-command', '~> 0.9', require: false
gem 'tty-prompt', '~> 0.21', require: false
gem 'twitter-text', '~> 1.14'
gem 'tzinfo-data', '~> 1.2020', '>= 1.2020.2'
